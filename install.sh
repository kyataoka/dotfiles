...
open "x-apple.systempreferences:com.apple.systempreferences.AppleIDSettings?root=APPLE_ACCOUNT&path=ICLOUD_SERVICE&dataclassId=com.apple.Dataclass.Ubiquity"
